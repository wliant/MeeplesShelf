    ...
    return (
      <Box sx={{ textAlign: "center", mt: 8 }}>
        ...
        <Typography color="text.secondary">
          Log in as a guest to see your personal dashboard.
        </Typography>
      </Box>
    );
  }
  ...
  return (
    <Box>
      <Typography variant="h4" gutterBottom>
        Welcome, {playerName ?? stats.player_name}
      </Typography>
              ...
              >
                ...
                <Typography
                  ...
                  sx={{
                    mt: 1,
                    fontSize:
                      typeof c.value === "string" && c.value.length > 6
                        ? "1.2rem"
                        : undefined,
                  }}
                >
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <Paper sx={{ p: 2 }}>
            ...
            <TableContainer
              component={Paper}
              variant="outlined"
              sx={{ mt: gameChartData.length > 0 && !isMobile ? 2 : 0 }}
            >
              <Table size="small">
                <TableHead>
                  <TableRow>
